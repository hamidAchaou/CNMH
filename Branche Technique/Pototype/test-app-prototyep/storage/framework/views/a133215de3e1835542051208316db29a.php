...
<div class="modal fade" id="modalDeleteTask" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo e(route('task.delete')); ?>" method="POST" class="modal-footer">
            <?php echo csrf_field(); ?>
  ...
  </script><?php /**PATH C:\xampp\htdocs\__SoliCoders\CNMH\Branche Technique\Pototype\app-prototyep\resources\views/components/modal-deleteTask.blade.php ENDPATH**/ ?>
...
<div class="modal fade" id="modal-projectDelete" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo e(route('projectsDelete')); ?>" method="POST" class="modal-footer">
            <?php echo csrf_field(); ?>
  ...
  </script><?php /**PATH C:\xampp\htdocs\__SoliCoders\CNMH\Branche Technique\Pototype\app-prototyep\resources\views/components/modal-deleteProject.blade.php ENDPATH**/ ?>
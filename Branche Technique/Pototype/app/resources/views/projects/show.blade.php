        ...
        <div class="mt-4 container row justify-content-around">
            ...
            <div class="w-25 d-flex flex-row-reverse form-group col-md-4">
                <a href="{{ route('create.task', ['id' => $project->id]) }}" class="btn btn-success">
                    <i class="fas fa-plus"></i> {{ __('words.new_task') }}
                </a>
            </div>
        </div>
    </div>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <button type="button" class="btn btn-sm btn-default bg-danger"
                                    onclick="AddIdTasks({{ $project->id }})" data-toggle="modal" data-target="#modalDeleteTask">
            ...
            <div class="">
                <div class="d-flex">
                    ...
                    <form class="ml-1" action="" method="post" id="importForm" enctype="multipart/form-data">
                        ...
                        <button type="button" class="btn" id="chooseFileButtonImporter">
                            <i class="fa-solid fa-file-export"></i> {{ __('words.import') }}</button>
                    </form>
                </div>
            </div>
            <!-- Pagination Links -->
